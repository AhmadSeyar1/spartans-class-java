...
public class WhatIsAbstraction {
    ...
    the functionality to the users. Example: Mobile phone. A layman who is using mobile phone
    doesn't know how it works internally but he can make phone calls.
     */
}
